...
#(
  ...
  input [9:0] t_r_i,      // rise time of both SDA and SCL in clock units                                   // Reduced from [12:0]
  input [8:0] t_f_i,      // fall time of both SDA and SCL in clock units                                   // Reduced from [12:0]
  ...
  input [30:0] host_nack_handler_timeout_i, // Timeout threshold for unhandled Host-Mode 'nak' irq.          // Reduced from [30:0]
