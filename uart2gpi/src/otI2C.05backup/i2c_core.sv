...
//   output logic                             intr_cmd_complete_o
  ...
  // hw2reg.controller_events.bus_timeout.de = event_bus_active_timeout && !host_idle;
  // assign hw2reg.controller_events.bus_timeout.de = !host_idle;
...
// Reg2hw Assigns
  ...
  i2c_controller_fsm #(
    ...
    .host_nack_handler_timeout_i    (10'd1020),                     // Timeout threshold for unhandled Host-Mode 'nak'
    .host_nack_handler_timeout_en_i (1),
