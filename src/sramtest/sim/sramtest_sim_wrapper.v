...
module chip_wrapper #(
    ...
    assign bidir_pads[`PAD_SRAM_SPICLK]     = spi_sclk;
    assign bidir_pads[`PAD_SRAM_SPICS]      = spi_cs_sram;
    assign bidir_pads[`PAD_SRAM_SPIMOSI]    = spi_mosi;
    assign spi_miso = bidir_pads[`PAD_SRAM_SPIMISO];    
    
    assign in_pads[`PADI_SEF_SPICS] = spi_cs_efuse;
